...
<head>
    ...
    <link href="WEB-INF/css/form.css" rel="stylesheet" type="text/css" media="all" />

    <script type="text/javascript" src="WEB-INF/js/jquery1.min.js"></script>
    <!-- start menu -->
    <link href="WEB-INF/css/megamenu.css" rel="stylesheet" type="text/css" media="all" />
    <script type="text/javascript" src="WEB-INF/js/megamenu.js"></script>
    <script>$(document).ready(function(){$(".megamenu").megamenu();});</script>
    <!--start slider -->
    <link rel="stylesheet" href="WEB-INF/css/fwslider.css" media="all">
    <script src="WEB-INF/js/jquery-ui.min.js"></script>
    <script src="WEB-INF/js/css3-mediaqueries.js"></script>
    <script src="WEB-INF/js/fwslider.js"></script>
    <!--end slider -->
    <script src="WEB-INF/js/jquery.easydropdown.js"></script>
</head>
<body>
    ...
    <div class="wrap">
        ...
        <div class="cssmenu">
            <ul>
                ...
                <li><a href="toLogin.action">Log In</a></li> |
...
<div class="copyrights">Collect from <a href="#">yitheme</a></div>
<!-- start slider -->
<div id="fwslider">
