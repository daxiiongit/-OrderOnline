        ...
        <div class="col_1_of_login span_1_of_login">
            <div class="login-title">
                ...
                <div id="loginbox" class="loginbox">
                    <form action="${pageContext.request.contextPath }/loginAdmin.action" method="post" name="login" id="login-form">
                        <fieldset class="input">
                            <p id="login-form-username">
                                <label for="modlgn_username">Email</label>
                                <input id="modlgn_username" type="text" name="loginname" class="inputbox" size="18"
                                       autocomplete="off">
                            </p>
                            <p id="login-form-password">
                                <label for="modlgn_passwd">Password</label>
                                <input id="modlgn_passwd" type="password" name="loginpwd" class="inputbox" size="18"
                                       autocomplete="off">
                            </p>
                            <div class="remember">
                ...
                <div class="col_1_of_f_1 span_1_of_f_1">
                    <div class="section group example">
                        <div class="col_1_of_f_2 span_1_of_f_2">
                            ...
                            <div class="like_box">
                                <div class="fb-like-box" data-href="" data-colorscheme="light" data-show-faces="true"
