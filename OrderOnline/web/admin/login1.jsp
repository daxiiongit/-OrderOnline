...
<div class="logintop">    
    ...
    <div class="loginbody">
        ...
        <div class="loginbox">
            <form action="loginAdmin.action" method="post" id="login">
                <ul>
                    <li><input name="loginname" type="text" class="loginuser" value="admin"
                               onclick="JavaScript:this.value=''"/></li>
                    <li><input name="loginpwd" type="password" class="loginpwd" value="密码"
                               onclick="JavaScript:this.value=''"/></li>
